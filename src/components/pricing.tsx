const plans = [
  {
    ...
    features: ["100 errors / month", "All languages", "CLI + web app", "Basic explanations", "Community support"],
    cta: "Get started",
    dark: false,
  },
  {
    ...
    features: ["Unlimited errors", "All languages + frameworks", "VS Code + CLI + CI", "Deep AI explanations", "Priority support", "Team patches"],
